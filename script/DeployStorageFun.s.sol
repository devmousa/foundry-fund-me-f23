...
contract DeployFunWithStorage is Script {
    ...
    function printFirstArrayElement(address contractAddress) public view {
        ...
        bytes32 secondElementStorageSlot = bytes32(uint256(firstElementStorageSlot) + 1);
        bytes32 firstElementStorageSlotValue = vm.load(contractAddress, firstElementStorageSlot);
        bytes32 secondElementStorageSlotValue = vm.load(contractAddress, secondElementStorageSlot);
        console.log("First element in array:");
        console.logBytes32(firstElementStorageSlotValue);
        console.log("Second element in array:");
        console.logBytes32(secondElementStorageSlotValue);
    }
